...
def main():
    ...
    print single_result.ix[:, ["day_date", "week_pulse", "day_force_ema", "model_signal", "day_open", "day_close", "enter_point", "stop_point", "target_point", "profit", "risk", "profit_risk_ratio", "profit_ratio", "week_close_ema_short", "week_close_ema_long"]]
